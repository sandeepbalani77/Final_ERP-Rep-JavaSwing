...
public class AddressResponse {
    ...
    public AddressResponse(String addressId, String cityTown, String stateCountryProvince, String zip, String country) {
        this.addressId = addressId;
        this.cityTown = cityTown;
        this.stateCountryProvince = stateCountryProvince;
        this.zip = zip;
